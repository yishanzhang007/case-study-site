                    ...
                    <div className="fullscreen-modal-svg-overlay" style={{
                      ...
                      {cardConfigs[activeCard].customModal === 'onboarding' ? (
                        <div style={{
                          ...
                          <img src="/assets/full onboarding 1.svg" alt="" style={{ maxWidth: '100%', height: 'auto', opacity: 1, borderRadius: isSmall ? 4 : 12, background: 'transparent' }} />
                          <img src="/assets/full onboarding 2.svg" alt="" style={{ maxWidth: '100%', height: 'auto', opacity: 1, borderRadius: isSmall ? 4 : 12, background: 'transparent' }} />
                        </div>
                      ) : (
                        <div style={{
